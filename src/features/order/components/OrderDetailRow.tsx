...
import { FiChevronUp, FiXSquare } from 'react-icons/fi';
...
import useOpenController from 'features/tables/hooks/useOpenController';
import { useSendOrderToKitchen } from 'features/tables/api/sendOrderToKitchen';
import { useOrderCancel } from 'features/tables/api/orderCancel';
import Banner from 'components/Banner';
import TableOrderItem from 'features/tables/components/TableOrderItem';
...
Props) => {
	...
	const { data: invoiceData, refetch: refetchInvoice } = useGetInvoice({
		params: {
							...
							<div className='text-white border px-[21px] border-r-gray4 lg:basis-1/4 basis-1/2 border-b-gray4 lg:border-b-0'>
								<div className='h-full flex flex-col '>
									...
									{orderData?.paymentStatus === 'Paid' &&
										orderData.invoiceStatus === 'Invoiced' && (
												<Button
